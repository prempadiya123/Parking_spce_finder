...
public final class ActivityDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout fream;

  private ActivityDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavigationView, @NonNull FrameLayout fream) {
  ...
  public static ActivityDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fream;
      FrameLayout fream = ViewBindings.findChildViewById(rootView, id);
      if (fream == null) {
        break missingId;
      }

      return new ActivityDashboardBinding((ConstraintLayout) rootView, bottomNavigationView, fream);
    }
